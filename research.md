...
<div class="academic-page research-page">

<div class="academic-intro">
<p>My research examines how political elites are selected, how hierarchical institutions shape their careers and behavior, and how political actors perform authority, conflict, and emotion. I study these questions across authoritarian, democratic, and international institutions. A related methodological agenda develops the data and measurement infrastructure required for comparative research, including longitudinal political biographies, auditable AI-assisted data construction, and multimodal analysis.</p>

<p>For datasets, measurement systems, and platform access, see the <a href="/data.html">Data page</a>.</p>
</div>

<section class="academic-section" aria-labelledby="publications-title">
<header class="academic-section-header">
<p class="academic-section-kicker">Published work</p>
<h2 class="academic-section-title" id="publications-title">Publications</h2>
</header>

<article class="academic-paper">
<h3 class="academic-item-title academic-paper-title">
<a href="/assets/pdfs/JiangYang_Face.pdf" target="_blank">“Portraits of Power: Facial Appearances and the Tacit Domain of Political Selection in China.”</a>
</h3>
...
<article class="academic-paper">
<h3 class="academic-item-title academic-paper-title">
<a href="/assets/pdfs/INTA99_4_LiuYang.pdf" target="_blank">“China and the Liberal International Order: A Pragmatic and Dynamic Approach.”</a>
</h3>
<p class="academic-item-meta">
...
<section class="academic-section" aria-labelledby="review-title">
<header class="academic-section-header">
<p class="academic-section-kicker">Current submissions</p>
<h2 class="academic-section-title" id="review-title">Papers Under Review</h2>
</header>

<article class="academic-paper">
<h3 class="academic-item-title academic-paper-title">
<a href="/assets/pdfs/political_fact_extraction_20260305.pdf" target="_blank">“Agentic Framework for Political Biography Extraction.”</a>
</h3>
<p class="academic-item-meta">
...
<section class="academic-section" aria-labelledby="working-title">
<header class="academic-section-header">
<p class="academic-section-kicker">Research in progress</p>
<h2 class="academic-section-title" id="working-title">Working Papers</h2>
</header>

<article class="academic-paper">
<h3 class="academic-item-title academic-paper-title">“The Disciplined Face of Power: Affective Signaling and Hierarchical Rule in China.”</h3>
<p class="academic-item-meta"><em>Independent project in development.</em></p>
...
<article class="academic-paper">
<h3 class="academic-item-title academic-paper-title">“Winners Take All: Performance Targets, Bureaucratic Momentum, and Stratified Economic Growth in China.”</h3>
<p class="academic-item-meta"><em>Working paper.</em></p>
